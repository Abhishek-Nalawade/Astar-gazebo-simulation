...
class Astar():
    ...
    #can add time required to the duplicate canvas and check for each small step if it is the goal
    #check from duplicate canvas if visited or not to not mark the clearance in cv visualization
